...
/** Upgrades only the exact Feign OkHttp source versions selected by the migration workbook. */
public final class UpgradeSelectedFeignOkHttpDependency extends Recipe {
    static final String GROUP = "io.github.openfeign";
    static final String ARTIFACT = "feign-okhttp";
    static final Set<String> SOURCE_VERSIONS = Set.of("10.4.0", "11.1", "12.4");
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Feign OkHttp dependencies to 13.6";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact io.github.openfeign:feign-okhttp source versions listed by the workbook in owned " +
