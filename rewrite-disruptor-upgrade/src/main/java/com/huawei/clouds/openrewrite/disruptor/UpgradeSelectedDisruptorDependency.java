...
public final class UpgradeSelectedDisruptorDependency extends Recipe {
    static final String GROUP = "com.lmax";
    static final String ARTIFACT = "disruptor";
    static final Set<String> SOURCE_VERSIONS = Set.of("3.4.2", "3.4.4");
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Disruptor dependencies to 4.0.0";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact com.lmax:disruptor versions listed by the workbook in owned " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isDisruptorDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isDisruptorDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isDisruptorDependency(dependencyCursor, dependency);
    }
