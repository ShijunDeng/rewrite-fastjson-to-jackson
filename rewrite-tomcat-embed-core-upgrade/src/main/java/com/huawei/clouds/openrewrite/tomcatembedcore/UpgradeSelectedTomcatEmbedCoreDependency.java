...
public final class UpgradeSelectedTomcatEmbedCoreDependency extends Recipe {
    static final String GROUP = "org.apache.tomcat.embed";
    static final String ARTIFACT = "tomcat-embed-core";
    ...
    static final String TARGET = "10.1.57";
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Tomcat Embed Core dependencies to 10.1.57";
    }

    @Override
    public String getDescription() {
        return "Upgrade only the 38 exact Tomcat 9.0 and 10.1 source versions supplied for remediation " +
               "in owned Maven or root Gradle declarations; external owners, variants, ranges, and all other versions " +
               "remain untouched.";
    }
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isTomcatEmbedCoreDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isTomcatEmbedCoreDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isTomcatEmbedCoreDependency(dependencyCursor, dependency);
    }
