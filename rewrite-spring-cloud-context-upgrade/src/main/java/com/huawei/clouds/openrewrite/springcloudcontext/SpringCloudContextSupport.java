...
final class SpringCloudContextSupport {
    static final String GROUP = "org.springframework.cloud";
    static final String ARTIFACT = "spring-cloud-context";
    static final String TARGET = "4.3.2";
    static final Set<String> SOURCES = Set.of("2.1.5.RELEASE", "3.1.1", "3.1.6", "3.1.7");
    ...
    private SpringCloudContextSupport() {
    }

    /** Only parent components are considered; a leaf such as install.gradle remains eligible. */
    ...
    static boolean isSpringCloudContextDependency(Cursor cursor, Xml.Tag tag) {
