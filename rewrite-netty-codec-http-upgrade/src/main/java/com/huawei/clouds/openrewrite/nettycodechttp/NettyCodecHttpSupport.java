...
final class NettyCodecHttpSupport {
    static final String GROUP = "io.netty";
    static final String ARTIFACT = "netty-codec-http";
    static final String TARGET = "4.1.136.Final";
    static final String DOWNGRADE_CONFLICT = "4.2.10.Final";
    static final Set<String> AUTO_SOURCES = Set.of(
            "4.1.49.Final", "4.1.100.Final", "4.1.107.Final", "4.1.108.Final", "4.1.109.Final",
            "4.1.118.Final", "4.1.125.Final", "4.1.126.Final", "4.1.127.Final", "4.1.128.Final",
            "4.1.129.Final", "4.1.130.Final", "4.1.132.Final");
    static final Set<String> WORKBOOK_SOURCES = Set.of(
            "4.1.49.Final", "4.1.100.Final", "4.1.107.Final", "4.1.108.Final", "4.1.109.Final",
            "4.1.118.Final", "4.1.125.Final", "4.1.126.Final", "4.1.127.Final", "4.1.128.Final",
            "4.1.129.Final", "4.1.130.Final", "4.1.132.Final", DOWNGRADE_CONFLICT);
    ...
    static boolean isCodecHttpDependency(Cursor cursor, Xml.Tag tag) {
