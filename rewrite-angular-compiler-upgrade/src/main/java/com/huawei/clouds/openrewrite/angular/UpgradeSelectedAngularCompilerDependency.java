...
public final class UpgradeSelectedAngularCompilerDependency extends Recipe {
    ...
    public String getDisplayName() {
        return "Upgrade selected @angular/compiler declarations to 20.3.26";
    }

    @Override
    public String getDescription() {
        return "Updates exact, caret, or tilde single-version @angular/compiler declarations selected by the " +
               "spreadsheet without changing ranges, protocols, variables, metadata, central owners, or lockfiles.";
    }
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new JsonIsoVisitor<ExecutionContext>() {
            ...
            public Json.Member visitMember(Json.Member member, ExecutionContext ctx) {
                ...
                if (!isPackageJson() || !"@angular/compiler".equals(key(visited)) ||
