...
/**
 * The body-preserving gap left by the official JUnit 6 recipe.
 *
 * <p>The upstream recipe removes the obsolete two-argument interceptor. This
 * migration instead adapts it to the maintained three-argument signature so
 * application-owned interception logic is retained.</p>
 */
public final class MigrateJUnitJupiter6Java extends Recipe {
    ...
    public String getDisplayName() {
        return "Preserve JUnit Jupiter dynamic-test interceptor bodies";
    }

    @Override
    public String getDescription() {
        return "Adapt deprecated two-argument dynamic-test interceptors to the maintained JUnit 6 signature " +
               "without deleting their application-owned method bodies.";
    }
